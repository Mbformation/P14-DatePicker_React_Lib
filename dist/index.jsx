...
function DatePicker(_ref) {
  var onChange = _ref.onChange,
    _ref$id = _ref.id,
    id = _ref$id === void 0 ? "datepicker-react-lib" : _ref$id,
    _ref$format = _ref.format,
    format = _ref$format === void 0 ? "MM/DD/YYYY" : _ref$format;
  var datepickerRef = React.useRef(); // useRef() to create an object with a .current property
  ...
  React.useEffect(function () {
    var datepicker = new pikaday({
      ...
      // Pikaday class requires the DOM reference
      format: format,
      // optional date format string
      onSelect: function onSelect() {
        // function is triggered user selects a date
        var currentDate = this.getMoment().format(format); // recuperate the date at the specified format
        updateDate(currentDate);
      }
    });
    return function () {
      return datepicker.destroy();
    }; // destroy Pikaday instance when component unmounts
  }, [onChange, format]);
